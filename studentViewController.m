...
- (void)viewDidLoad
{
    ...
    cellData = [[NSMutableArray alloc] initWithArray: [data objectForKey:@"students"]];
    
//    cellData = [[NSMutableArray alloc] initWithObjects:@"Shikeen", @"Shahlan", @"Cikgu", @"WMF", @"Deno", @"Bell", @"Michael Jackson", @"Kak Rosmah Mansor", @"Datok K", @"TG Nik Aziz", @"Hercules", @"Clark Kent", nil];
